...
<main class="flex flex-col items-center justify-center text-center p-4 sm:p-6 md:p-8">
    <!-- not sure if I should make the  flower smaller or bigger -->
    ...
    <div class="flex flex-wrap flex-col  md:flex-row font-bold justify-center p-4 sm:p-5 md:p-8 w-full gap-4">
        <div class="bg-[#F5ECDE] w-full md:w-full lg:w-2/5 h-auto rounded-3xl p-5 m-5">
            ...
            <p class="text-base  sm:text-lg text-[#294105]">
    ...
    <img class="w-24 sm:w-30 lg:w-36 py-5 " src="{lotus}" alt="lotus-flower"/>
    <h1 class="text-5xl sm:text-6xl md:text-8xl font-black uppercase text-[#6BD1A9] stroke-5 py-6">What Can We Look Forward To?</h1>
