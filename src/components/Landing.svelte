...
<script>
	...
	let containers = [
		{
			title: "DATE",
			description: "NOV. 9 - NOV. 10",
			image: '/Assets/Landing/lilly_pad.webp'
		},
		{
			title: "DURATION",
			description: "24 HOURS",
			image: '/Assets/Landing/opposite_lilly_pad.webp'
		},
		{
			title: "LOCATION",
			description: "VIRTUAL",
...
<main>
	<NavBar />
	<div class="relative">
			<!-- Use a wrapper with absolute positioning for layered images -->
			<div class="relative">
					<img src='/Assets/Landing/sunset.webp' alt="Sunset" class="max-w-screen mt-12 mb-48 max-w-full sm:mt-8 md:w-3/4 md:mx-auto md:mt-12 lg:mt-16" loading="lazy"/>
					<img src='/Assets/Landing/hills_background.webp' alt="Hills" class="hidden md:block md:w-full md:absolute md:z-10 md:top-28" loading="lazy"/>
					<img src="/Assets/Landing/layered_green.svg" alt="Grass" class="hidden md:block md:w-full md:absolute md:z-10 md:top-2/3" loading="lazy"/>
					<img src='/Assets/Landing/side_leaves.webp' alt="Side Leaves" class="hidden md:block md:w-1/3 md:absolute md:z-30 md:top-24 md:right-0" loading="lazy"/>
			</div>
			...
			<div class="absolute bg-[#78BFCE] top-64 sm:top-96 md:top-full left-0 w-full z-10">
					<div class="absolute w-full grid items-center">
							<img src='/Assets/Landing/dark_waves.png' alt="Dark Waves" class="max-w-screen block absolute left-0 z-10" loading="lazy"/>
							<img src='/Assets/Landing/light_waves.png' alt="Light Waves" class="max-w-screen block absolute left-0 z-10" loading="lazy"/>
							<img src='/Assets/Landing/lotus_on_lilly_pad2.webp' alt="Lotus on Lilly Pad" class="hidden md:block md:w-28 lg:w-36 absolute md:z-20 md:bottom-0 md:left-3" loading="lazy"/>
							<img src='/Assets/Landing/lotus_on_lilly_pad.webp' alt="Lotus on Lilly Pad" class="hidden md:block md:w-28 lg:w-36 absolute md:z-20 md:bottom-0 md:right-56 lg:right-64" loading="lazy"/>
					</div>
					<div class="flex flex-col md:flex-row lg:flex-row items-center justify-center space-y-8 md:space-x-10 lg:space-x-20 md:space-y-0 mt-44 sm:mt-20 m-4 p-10">
							{#each containers as container}
									<div class="border-dashed border-8 border-[#89CAD8] w-72 md:w-80 lg:w-80 h-52 relative flex items-center justify-center">
											...
											<span class="text-[#000000] text-3xl sm:text-xl lg:text-3xl font-extrabold absolute">{container.description}</span>
											<img src={container.image} alt="Lilly Pad" class="absolute w-40 bottom-3 sm:w-28 md:w-40" loading="lazy"/>
									</div>
							{/each}
					</div>
			</div>
