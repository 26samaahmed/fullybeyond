...
<main>
	...
	<div class="relative">
			...
			<div class="relative">
					<img src={sunset} alt="Sunset" loading="lazy" class="max-w-screen mt-12 mb-48 max-w-full sm:mt-8 md:w-3/4 md:mx-auto md:mt-12 lg:mt-16" />
					<img src={hills} alt="Hills" loading="lazy" class="hidden md:block md:w-full md:absolute md:z-10 md:top-28" />
					<img src={grass} alt="Grass" loading="lazy" class="hidden md:block md:w-full md:absolute md:z-10 md:top-2/3" />
			...
			<div id="center-introduction" class="absolute w-full flex flex-col items-center top-12 sm:top-28 md:top-28 lg:top-44 z-20">
					...
					<div class="flex flex-col sm:flex-row justify-center sm:space-x-20 md:space-x-14 mt-16 sm:mt-12">
							...
							<button class="text-xl md:text-base bg-[#FFE8C5] text-[#A95271] border-2 border-[#E0A246] rounded-3xl w-48 md:w-36 h-14 font-light hover:text-white hover:bg-[#A95271] transition-all duration-700 ease-in-out z-20"><a href={sponsor_package} target="_blank">Sponsor Us!</a></button>
					</div>
			</div>
			<div class="absolute bg-[#78BFCE] top-64 sm:top-96 md:top-full left-0 w-full z-10">
					<div class="absolute w-full grid items-center">
							...
							<img src={lotus_on_lilly_pad2} alt="Lotus on Lilly Pad" loading="lazy" class="hidden md:block md:w-28 lg:w-36 absolute md:z-20 md:bottom-0 md:left-3" />
							<img src={lotus_on_lilly_pad} alt="Lotus on Lilly Pad" loading="lazy" class="hidden md:block md:w-28 lg:w-36 absolute md:z-20 md:bottom-0 md:right-56 lg:right-64" />
					</div>
					<div class="flex flex-col md:flex-row lg:flex-row items-center justify-center space-y-8 md:space-x-10 lg:space-x-20 md:space-y-0 mt-44 sm:mt-20 m-4">
							{#each containers as container}
									<div class="border-dashed border-8 border-[#89CAD8] w-72 md:w-80 lg:w-80 h-52 relative flex items-center justify-center">
											...
											<img src={container.image} alt="Lilly Pad" loading="lazy" class="absolute w-40 bottom-3 sm:w-28 md:w-40" />
									</div>
							{/each}
					</div>
			</div>
